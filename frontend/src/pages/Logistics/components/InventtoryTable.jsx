  ...
  const dynamicLedger = [
    {
        ...
        current_stock: `${Math.round(fuel.current_level_liters || 0).toLocaleString()} L`,
        capacity_max: `${Math.round(fuel.total_capacity_liters || 50000).toLocaleString()} L`,
        burn_rate: `${formatMetric(fuel.consumption_rate_liters_per_day, 0)} L/day`,
    ...
    },
    {
        ...
        current_stock: `${Math.round(food.current_stock_kg || 0).toLocaleString()} kg`,
        capacity_max: "4,000 kg",
        burn_rate: "30 kg/day",
    ...
    },
    {
        ...
        current_stock: `${Math.round(emergencyFuel.current_level_liters || 0).toLocaleString()} L`,
        capacity_max: `${Math.round(emergencyFuel.total_capacity_liters || 10000).toLocaleString()} L`,
    ...
    ...backendLedger.map((item, index) => ({
        ...
        current_stock: `${item.current_stock || item.qty || 0} Units`,
        capacity_max: `${item.capacity_max || "N/A"}`,
        ...
        <table className="w-full text-left text-sm min-w-[800px]">
          ...
          <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80">
            {dynamicLedger.map((row, idx) => {
              // Match exact styling styling from your UI design
